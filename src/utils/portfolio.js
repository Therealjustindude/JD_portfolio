export const PROFILE = {
	...
	socials: [
		{
			label: 'GitHub',
			href: 'https://github.com/Therealjustindude',
			handle: '@Therealjustindude'
		},
		{
			label: 'LinkedIn',
			href: 'https://www.linkedin.com/in/justin-j-davies/',
			handle: 'in/justin-j-davies'
		}
	]
};
...
export const STACK = [
	...
	{ name: 'TanStack Start', level: 'daily' },
	{ name: 'TypeScript', level: 'daily' },
	{ name: 'Tailwind', level: 'daily' },
	{ name: 'Playwright', level: 'daily' },
	{ name: 'Svelte', level: 'project' },
	{ name: 'Vue', level: 'project' },
	{ name: 'Railway', level: 'project' },
	{ name: 'Kotlin', level: 'learning' },
	{ name: 'Java', level: 'learning' },
	{ name: 'Next.js', level: 'past' },
	{ name: 'Go', level: 'past' },
	{ name: 'Material UI', level: 'past' },
	{ name: 'Ruby on Rails', level: 'past' }
];
